# Helpers from the taming project
import importlib
...
from dataset.models import Annotation, Image
...
def get_layout_conditioning(cond_stage_model, layout_bounding_box_tensor):

    condition = cond_stage_model.encode(layout_bounding_box_tensor) # SE: Gets an embedding of the condition (should be one of these ldm/modules/encoders/modules.py)
